...
$('.search-form form').submit(function(){
	$('#repositorio-troncal-app-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Repositorio Troncal Apps</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'repositorio-troncal-app-grid',
			...
			'class'=>'CButtonColumn',
                        ...
                        'buttons' => array(
                                    'asignar' => array(
                                            ...
                                            'url'=>'Yii::app()->createUrl("repositorio/repositoriotroncalapp/asignarmodeloaprendizaje",array("id"=>$data->id) )', //url de la acción nueva
                                    ),
                        ),
		),
	),
