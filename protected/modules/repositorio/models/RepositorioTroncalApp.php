...
/**
 * This is the model class for table "repositorio_troncal_app".
 *
 * The followings are the available columns in table 'repositorio_troncal_app':
 * @property integer $id
 ...
 */
class RepositorioTroncalApp extends CActiveRecord
{
	/**
	...
	{
		return 'repositorio_troncal_app';
	}
	 ...
	 * @return RepositorioTroncalApp the static model class
	 */
	public static function model($className=__CLASS__)
	{
		return parent::model($className);
	}
        public function asignarModeloAprendizajeRepositorioTroncalApp($nuevo_repositorio_id,$nuevo_modelo_id) {
            
            $comando = Yii::app()->db->createCommand("CALL sp_repositorio_asignar_mod_aprendizaje_rep_troncal_app(:nuevo_repositorio_id,:nuevo_modelo_id)");
