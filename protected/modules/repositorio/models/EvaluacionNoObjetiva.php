...
/**
 * This is the model class for table "evaluacion_no_objetiva".
 *
 * The followings are the available columns in table 'evaluacion_no_objetiva':
 * @property integer $id
 ...
 */
class EvaluacionNoObjetiva extends CActiveRecord
{
	/**
	 ...
	 * @return EvaluacionNoObjetiva the static model class
	 */
