...
/**
 * This is the model class for table "trabajo_grupal".
 *
 * The followings are the available columns in table 'trabajo_grupal':
 * @property integer $id
 ...
 */
class TrabajoGrupal extends CActiveRecord
{
	/**
	 ...
	 * @return TrabajoGrupal the static model class
	 */
